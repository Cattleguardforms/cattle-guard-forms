...
function normalizeContact(record: RawRecord, index: number): CrmContactRecord {
  return {
    ...
    company: getString(record, ["company", "company_name", "business_name", "organization", "customer_company"]),
    company_email: getString(record, ["company_email", "business_email"]),
    company_phone: getString(record, ["company_phone", "business_phone"]),
    city: getString(record, ["city", "shipping_city", "billing_city"]),
    state: getString(record, ["state", "shipping_state", "billing_state"]),
