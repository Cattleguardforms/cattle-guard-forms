  ...
  async function fetchBol(orderId: string) {
    ...
    try {
      ...
      if (response.ok && contentType.includes("application/pdf")) {
        ...
        const filename = match?.[1] || `Echo-BOL-${shortId(orderId)}.pdf`;
        ...
        setNotice(`Downloaded Echo BOL: ${filename}`);
        await loadOrders();
        return;
      }
      const payload = (await response.json()) as BookingPayload;
