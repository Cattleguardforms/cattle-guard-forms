...
type ActionPayload = { ok?: boolean; error?: string; bolNumber?: string; echoLoadId?: string; echoResponse?: unknown; shipmentRequest?: unknown; status?: number; statusText?: string; attemptedPaths?: unknown; recipients?: string[]; bolFileName?: string; result?: unknown };
...
export default function AdminShippingExecutionPage() {
  ...
  async function fetchBol(orderId: string) {
    ...
    try {
      ...
      try {
        const payload = JSON.parse(text) as ActionPayload;
        setLastResult(payload);
