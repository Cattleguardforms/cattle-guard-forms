...
export default function ShopClient() {
  ...
  function handlePhoneChange(value: string) {
    setPhone(value);
    if (!customerPhone.trim()) setCustomerPhone(value);
    resetQuote();
  }
