...
const palletRows = [
  { qty: 1, dimensions: "72 x 48 x 20 in", weight: "105 lb" },
  { qty: 2, dimensions: "72 x 48 x 20 in", weight: "190 lb" },
  { qty: 3, dimensions: "72 x 48 x 36 in", weight: "270 lb" },
  { qty: 4, dimensions: "72 x 48 x 36 in", weight: "355 lb" },
  { qty: 5, dimensions: "72 x 48 x 52 in", weight: "440 lb" },
  { qty: 6, dimensions: "72 x 48 x 52 in", weight: "525 lb" },
];

type CheckoutResponse = { url?: string; error?: string };
type ProfileResponse = { ok?: boolean; error?: string; profile?: { email: string; companyName?: string; pricePerUnit?: number } };

function palletCount(qty: number) {
