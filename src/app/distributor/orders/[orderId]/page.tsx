...
export default function DistributorOrderDetailPage() {
  ...
  <section className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-950"><p className="font-bold">BOL file status</p><p className="mt-2">If the admin has booked Echo freight and fetched the BOL, the BOL number appears here. The next workflow stores the downloaded BOL file with the order so it can be re-downloaded here without asking Echo again.</p></section>
</section></main>;
}
